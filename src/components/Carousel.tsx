...
export function Carousel({ posts }: CarouselProps) {
  ...
  return (
    ...
    >
      <div className='w-full h-full ' onClick={handleCarouselClick}>
        <div className=' w-full h-full relative select-none'>
          ...
          <div className='absolute top-0 w-full rounded-lg h-full bg-slate-900 bg-opacity-40 md:p-12 flex items-center'>
